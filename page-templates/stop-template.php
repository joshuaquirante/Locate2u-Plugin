...
<?php 
$check_business_name = check_business_name()["settings_value"];
$check_logo_url = check_business_logo()["settings_value"];
	...
	<div class="container">
		<div class="row">
			<div class="business-identity-container">
				<?php if($check_logo_url != 0) : ?>
					<img class="img-fluid" src="<?php echo esc_attr($check_logo_url); ?>" />
				<?php endif; ?>

				<?php if($check_business_name != 0) : ?>
					<h1><?php echo esc_attr($check_business_name); ?></h1>
				<?php endif; ?>	
			</div>
